...
namespace WebApp.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            IEnumerable<Product> objList = _db.Product.Include(u => u.ApplicationType).Include(u => u.Category);

            //foreach (var obj in objList)
            //{
            //    obj.Category = _db.Category.FirstOrDefault(u => u.Id == obj.CategoryId);
            //    obj.ApplicationType = _db.ApplicationType.FirstOrDefault(u => u.Id == obj.AppTypeId);
            //};
